...
export type LoreEntry = { id:string; campaign_id:string; layer:LoreLayer; category:string; title:string; content:string; source_id?:string; location_id?:string; created_at:string }
export type HexCell = { id:string; campaign_id:string; q:number; r:number; terrain:string; title:string; discovery:'hidden'|'discovered'|'explored'; travel_cost:number; encounter_chance:number; player_notes:string; dm_notes:string; location_id?:string; source_id?:string }
...
export type HexcrawlSettings = { campaign_id:string; track_weather:boolean; track_navigation:boolean; track_food:boolean; track_water:boolean; track_fatigue:boolean; track_encounters:boolean; track_foraging:boolean; auto_discover:boolean; default_pace:'slow'|'normal'|'fast'; hex_distance:number; distance_unit:'km'|'miles' }
